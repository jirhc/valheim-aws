...
# ─────────────────────────────────────────────────────────────────────────────
install_bepinex() {
    local version="${BEPINEX_VERSION:-5.4.2202}"
    ...
    local url="https://github.com/BepInEx/BepInEx/releases/download/v${version}/BepInEx_unix_${version}.0.zip"
...
#    Mirrors the mods installed by the main project (install_bepinex.sh).
# ─────────────────────────────────────────────────────────────────────────────
